...
from src.analysis.analysis import get_data_kpi_week
...
from src.analysis.repository import load_activity_summary, load_records
...
def main():
    ...
    #-- 2.1.
    #-- - Carga de Records de actividades
    df_records = load_records()

    #-- - 3.
    #-- - Cálculo de KPIs/estadisticas
    kpis_week, df_sessions = get_data_kpi_week(df_summary, df_records, temporada)
    ...
    data_for_json = build_dashboard_v1(temporada, kpis_week, df_sessions)
